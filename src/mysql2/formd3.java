...
public class formd3 extends JPanel implements ActionListener{
						...
						if("确认".equals(e.getActionCommand()))
						{
							...
							try {
					            ...
					            //要执行的SQL语句
					             ...
					             sql = "delete from region where r_regionkey = "+shuxing+";";
					            
					            statement.execute(sql);
					            String[] shuxing2=jtf2.getText().split("//");
					            sql = "insert into region values("+shuxing2[n].toString()+","+shuxing2[n+1].toString()+","+shuxing2[n+2].toString()+");";
					            statement.execute(sql);
