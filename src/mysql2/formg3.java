...
public class formg3 extends JPanel implements ActionListener{
...
//**************************************************************************
	...
	public formg3(){
		...
		jtf2.setBounds(fX+100, l1Y+100, TextField.WIDTH, TextField.HEIGHT);
					...
					try{
						...
						if("确认".equals(e.getActionCommand()))
						{
							...
							try {
					            ...
					            String[] shuxing2=jtf2.getText().split("//");
					            sql = "insert into lineitem values("+shuxing2[n].toString()+","+shuxing2[n+1].toString()+","+shuxing2[n+2].toString()+","+shuxing2[n+3].toString()+","+shuxing2[n+4].toString()+","+shuxing2[n+5].toString()+","+shuxing2[n+6].toString()+","+shuxing2[n+7].toString()+","+shuxing2[n+8].toString()+","+shuxing2[n+9].toString()+","+shuxing2[n+10].toString()+","+shuxing2[n+11].toString()+","+shuxing2[n+12].toString()+","+shuxing2[n+13].toString()+","+shuxing2[n+14].toString()+","+shuxing2[n+15].toString()+");";
					            statement.execute(sql);
