...
public class formh3 extends JPanel implements ActionListener{
						...
						if("确认".equals(e.getActionCommand()))
						{
							...
							try {
					            ...
					            //要执行的SQL语句
					             ...
					             sql = "delete from orders where o_orderkey = "+shuxing+";";
					            
					            statement.execute(sql);
					            String[] shuxing2=jtf2.getText().split("//");
					            sql = "insert into orders values("+shuxing2[n].toString()+","+shuxing2[n+1].toString()+","+shuxing2[n+2].toString()+","+shuxing2[n+3].toString()+","+shuxing2[n+4].toString()+","+shuxing2[n+5].toString()+","+shuxing2[n+6].toString()+","+shuxing2[n+7].toString()+","+shuxing2[n+8].toString()+");";
					            statement.execute(sql);
