...
public class formd4 extends JPanel implements ActionListener{
...
//**************************************************************************
	...
	public formd4(){
		...
		String col[] = { "R_REGIONKEY", "R_NAME", "R_COMMENT"};
		String sn[][]=null; 
			...
			if("确认".equals(e.getActionCommand()))
			{
				...
				try {
		            ...
		            if(jtf1.getText().equals("*"))
		            	...
		            	{
		            	sql="select * from region where r_regionkey ="+jtf1.getText()+";";
		                 rs =statement.executeQuery(sql);
		                 }
		           String col[] = { "R_REGIONKEY", "R_NAME", "R_COMMENT"};
		           if(rs.last())
					...
					if(row == 0){
						...
						while(rs.next())       
						{ 
							sn[i][0] = rs.getString("R_REGIONKEY");       
							sn[i][1] = rs.getString("R_NAME");       
							sn[i][2] = rs.getString("R_COMMENT");       
