...
public class formc1 extends JPanel implements ActionListener {
								...
								if("确认".equals(e.getActionCommand()))
								{
									...
									try {
							            ...
							            //要执行的SQL语句
							             ...
							             sql = "insert into part values("+shuxing[n].toString()+","+shuxing[n+1].toString()+","+shuxing[n+2].toString()+","+shuxing[n+3].toString()+","+shuxing[n+4].toString()+","+shuxing[n+5].toString()+","+shuxing[n+6].toString()+","+");";	
