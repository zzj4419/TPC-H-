...
public class forme1 extends JPanel implements ActionListener {
								...
								if("确认".equals(e.getActionCommand()))
								{
									...
									try {
							            ...
							            //要执行的SQL语句
							             ...
							             sql = "insert into nation values("+shuxing[n].toString()+","+shuxing[n+1].toString()+","+shuxing[n+2].toString()+","+shuxing[n+3].toString()+");";	
