...
public class forme4 extends JPanel implements ActionListener{
...
//**************************************************************************
	...
	public forme4(){
		...
		String col[] = { "N_NATIONKEY", "N_NAME", "N_REGIONKEY","N_COMMENT"};
		String sn[][]=null; 
			...
			if("确认".equals(e.getActionCommand()))
			{
				...
				try {
		            ...
		            if(jtf1.getText().equals("*"))
		            	...
		            	{
		            	sql="select * from nation where N_NATIONKEY ="+jtf1.getText()+";";
		                 rs =statement.executeQuery(sql);
		                 }
		           String col[] = { "N_NATIONKEY", "N_NAME", "N_REGIONKEY","N_COMMENT"};
		           if(rs.last())
					...
					if(row == 0){
						...
						while(rs.next())       
						{ 
							sn[i][0] = rs.getString("N_NATIONKEY");       
							sn[i][1] = rs.getString("N_NAME");       
							sn[i][2] = rs.getString("N_REGIONKEY");       
							sn[i][3] = rs.getString("N_COMMENT");       
